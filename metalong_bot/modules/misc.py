...
from metalong_bot import dispatcher, OWNER_ID, SUDO_USERS, SUPPORT_USERS, WHITELIST_USERS, BAN_STICKER
from metalong_bot.__main__ import GDPR
from metalong_bot.__main__ import STATS, USER_INFO
