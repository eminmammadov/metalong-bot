...
import metalong_bot.modules.sql.global_bans_sql as gban_sql
import metalong_bot.modules.sql.users_sql as user_sql
from metalong_bot import dispatcher, OWNER_ID
